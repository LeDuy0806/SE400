...
func ErrDB(err error) *AppError {
	return NewFullErrorResponse(http.StatusInternalServerError, err, "something went wrong with DB", err.Error(), "DB_ERROR") //return NewErrorResponse(err, "something went wrong with DB", err.Error(), "DB_ERROR")
}
...
func ErrCannotUpdateEntity(entity string, err error) *AppError {
	return NewCustomError(
		...
		fmt.Sprintf("ErrCannot Update%s", entity),
	)
}
...
func ErrEntityExisted(entity string, err error) *AppError {
	return NewCustomError(
		...
		fmt.Sprintf("Err%sAlready Exists", entity),
	)
}
